...
function testCircle(x, y, color="white"){
    ctx.beginPath();
...
function connected(socket){
    ...
    if (Object.keys(playerPos).length === 0){
        ...
        //creating player 1
        serverBalls[socket.id] = new Capsule(80, 270, 150, 270, 20, 10);
        ...
        //creating player 2
        serverBalls[socket.id] = new Capsule(560, 270, 490, 270, 20, 10);
        serverBalls[socket.id].maxSpeed = 4;
        serverBalls[socket.id].score = 0;
        ...
        console.log("Already 2 members in game. Connecting as spectator.");
        return false;
    }
